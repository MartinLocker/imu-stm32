...
TwoWire ImuWire(1, I2C_REMAP | I2C_FAST_MODE);
...
bool MPU9250::scanSensors() {
  if (readByte(MPU9250_ADDRESS, INT_STATUS) & 0x01)
  {
    ...
    // otoceny senzor 
    my =   (float)magCount[0] * mRes * factoryMagCalibration[0] - magBias[0];
    mx =   (float)magCount[1] * mRes * factoryMagCalibration[1] - magBias[1];
...
void MPU9250::calibrateMPU9250(float * gyroBias)
{
...
void MPU9250::magCalMPU9250(float * bias_dest, float * scale_dest)
{
  ...
  int32_t mag_bias[3]  = {0, 0, 0},
          mag_scale[3] = {0, 0, 0};
  int16_t mag_max[3]  = {-32758, -32758, -32758},
          mag_min[3]  = {32757, 32757, 32757},
          mag_temp[3] = {0, 0, 0};
  ...
  for (ii = 0; ii < sample_count; ii++)
  {
    ...
    {
//#ifdef DEBUG
      DebugPort.print(mag_temp[0]); 
      DebugPort.print("\t");
      DebugPort.print(mag_temp[1]); 
      DebugPort.print("\t");
      DebugPort.println(mag_temp[2]);
//#endif
...
//#ifdef DEBUG
  DebugPort.print("mag x min/max: "); DebugPort.print(mag_max[0]); DebugPort.print(" "); DebugPort.println(mag_min[0]);
  DebugPort.print("mag y min/max: "); DebugPort.print(mag_max[1]); DebugPort.print(" "); DebugPort.println(mag_min[1]);
  DebugPort.print("mag z min/max: "); DebugPort.print(mag_max[2]); DebugPort.print(" "); DebugPort.println(mag_min[2]);
//#endif
